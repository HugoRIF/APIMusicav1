        ...
        switch($opcion){
                ...
                if($this->validar_parametros_get($nombre,$contrasenia)==1){
                    ...
                    if($usuario != 0){
                        ...
                        if($this->ver_tipo_usuario($usuario) == 2){
                            ...
                            $info_playlists=$this->Usuarios_model->info_playlists($usuario['id']);

                            if ($info_playlists != 0) {
                                #exito del query
                           
                                if(count($info_playlists) > 0){
                                    #Tiene al menos una playlists
                                    $playlists=$this->Usuarios_model->ver_playlists($usuario,$info_playlists);
                                    #checamos el exito del query
                                    if($playlists != 0){
            ...
            case 2:
                ...
                if (!is_null($usuarios)) {
                    ...
                    #query falla
                    $respuesta=$this->crear_respuesta(404,"error en la consulta de los usuarios", $usuarios);
                }
                break;
